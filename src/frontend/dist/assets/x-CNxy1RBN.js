...
import { p as ProtocolError, T as TimeoutWaitingForResponseErrorCode, q as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, t as lookupResultToBuffer, v as RequestStatusResponseStatus, U as UnknownError, w as RequestStatusDoneNoReplyErrorCode, x as RejectError, y as CertifiedRejectErrorCode, z as UNREACHABLE_ERROR, I as InputError, A as InvalidReadStateRequestErrorCode, B as ReadRequestType, P as Principal, D as IDL, F as MissingCanisterIdErrorCode, H as HttpAgent, G as encode, Q as QueryResponseStatus, J as UncertifiedRejectErrorCode, K as isV3ResponseBody, N as isV2ResponseBody, O as UncertifiedRejectUpdateErrorCode, V as UnexpectedErrorCode, W as decode, S as Subscribable, X as pendingThenable, Y as resolveEnabled, s as shallowEqualObjects, Z as resolveStaleTime, m as noop, _ as environmentManager, $ as isValidTimeout, a0 as timeUntilStale, a1 as timeoutManager, a2 as focusManager, a3 as fetchState, a4 as replaceData, n as notifyManager, r as reactExports, o as shouldThrowError, c as useQueryClient, u as useInternetIdentity, a5 as createActorWithConfig, j as jsxRuntimeExports, i as React, a6 as Record, a7 as Opt, a8 as Variant, a9 as Vec, aa as Service, ab as Func, ac as Principal$1, ad as Text, ae as Nat8, af as Null, ag as Nat, ah as Bool, ai as Int } from "./index-CebTjiTu.js";
...
const ProjectRecord = Record({
  ...
  "requirements": Text,
  "budget": Text,
  "assignedCandidates": Vec(Principal$1)
});
...
const CandidateId = Principal$1;
const PaymentStatus$1 = Variant({
  "NotPaid": Null,
  "Paid": Null,
  "Verified": Null
});
const RegistrationStatus$1 = Variant({
  "Approved": Null,
  "Suspended": Null,
  "Rejected": Null,
  "Pending": Null
...
const CandidateProfile = Record({
  ...
  "portfolioImages": Vec(ExternalBlob$1),
...
const NotificationRecord = Record({
  ...
  "createdAt": Timestamp,
  "isRead": Bool,
  "senderPrincipal": Principal$1,
  "message": Text,
  "recipientPrincipal": Principal$1
});
const PaymentId = Nat;
const PaymentRecordStatus = Variant({
  "Failed": Null,
  "Completed": Null,
  "Pending": Null
});
...
const CandidateProfileInput = Record({
  "age": Nat,
  "height": Text,
  "city": Text,
  "name": Text,
...
Service({
  ...
  "addProject": Func([ProjectInput], [ProjectRecord], []),
  "approveCandidate": Func([Principal$1], [], []),
  "assignCallerUserRole": Func([Principal$1, UserRole], [], []),
  "assignCandidateToProject": Func([ProjectId, Principal$1], [], []),
  "broadcastNotification": Func(
    [Vec(Principal$1), Text, NotificationType$1],
    [],
    []
  ),
  "createCheckoutSession": Func([Text, Text], [Text], []),
  "getCallerUserRole": Func([], [UserRole], ["query"]),
  "getCandidateDetail": Func(
    [Principal$1],
    [Opt(CandidateProfile)],
    ["query"]
  ),
  "getConfig": Func([], [AppConfig], ["query"]),
  "getMyNotifications": Func([], [Vec(NotificationRecord)], ["query"]),
  "getMyPaymentStatus": Func([], [Opt(PaymentRecord)], ["query"]),
  "getMyProfile": Func([], [Opt(CandidateProfile)], ["query"]),
  "getMyProjects": Func([], [Vec(ProjectRecord)], ["query"]),
  ...
  "listAllCandidates": Func([], [Vec(CandidateProfile)], ["query"]),
  "listApprovals": Func([], [Vec(UserApprovalInfo)], ["query"]),
  "listPayments": Func([], [Vec(PaymentRecord)], ["query"]),
  "listProjects": Func([], [Vec(ProjectRecord)], ["query"]),
  "markNotificationRead": Func([NotificationId], [], []),
  "recordPayment": Func([Text], [PaymentRecord], []),
  "registerCandidate": Func(
    [CandidateProfileInput],
    [CandidateProfile],
    []
  ),
  "rejectCandidate": Func([Principal$1], [], []),
  "requestApproval": Func([], [], []),
  "sendNotification": Func(
    [Principal$1, Text, NotificationType$1],
    [NotificationRecord],
    []
  ),
  ...
  "updateConfig": Func([AppConfig], [], []),
  "updateMyProfile": Func([CandidateProfileInput], [CandidateProfile], []),
  "updateProject": Func([ProjectId, ProjectInput], [ProjectRecord], []),
  "uploadPortfolioImages": Func([Vec(ExternalBlob$1)], [], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const ProjectCategory2 = IDL2.Variant({
    "Bridal": IDL2.Null,
    "MusicVideo": IDL2.Null,
    "ECommerce": IDL2.Null,
    "Fashion": IDL2.Null,
    "Jewellery": IDL2.Null,
    "International": IDL2.Null,
    "WebSeries": IDL2.Null,
    "BrandPromotion": IDL2.Null,
    "Catalogue": IDL2.Null
  });
  ...
  const ProjectRecord2 = IDL2.Record({
    "id": ProjectId2,
    "status": ProjectStatus2,
    "title": IDL2.Text,
    ...
    "requirements": IDL2.Text,
    "budget": IDL2.Text,
    "assignedCandidates": IDL2.Vec(IDL2.Principal)
  });
  ...
  const NotificationType2 = IDL2.Variant({
    "RegistrationUpdate": IDL2.Null,
    "Reminder": IDL2.Null,
    "Announcement": IDL2.Null,
    "ProjectMatch": IDL2.Null,
    "Offer": IDL2.Null
  });
  const CandidateId2 = IDL2.Principal;
  const PaymentStatus2 = IDL2.Variant({
    "NotPaid": IDL2.Null,
    "Paid": IDL2.Null,
    "Verified": IDL2.Null
  });
  const RegistrationStatus2 = IDL2.Variant({
    "Approved": IDL2.Null,
    "Suspended": IDL2.Null,
    "Rejected": IDL2.Null,
    "Pending": IDL2.Null
  ...
  const CandidateProfile2 = IDL2.Record({
    "id": CandidateId2,
    "age": IDL2.Nat,
    "height": IDL2.Text,
    ...
    "email": IDL2.Text,
    "updatedAt": Timestamp2,
    "measurements": IDL2.Text,
    "phone": IDL2.Text,
    "registrationStatus": RegistrationStatus2,
    "portfolioImages": IDL2.Vec(ExternalBlob2),
    "principalId": IDL2.Principal
  });
  const AppConfig2 = IDL2.Record({
    "stripePublicKey": IDL2.Text,
    "instagramHandle": IDL2.Text,
    "email": IDL2.Text,
    "whatsappNumber": IDL2.Text,
    "paymentAmount": IDL2.Nat
  });
  const NotificationId2 = IDL2.Nat;
  const NotificationRecord2 = IDL2.Record({
    "id": NotificationId2,
    "notificationType": NotificationType2,
    "createdAt": Timestamp2,
    "isRead": IDL2.Bool,
    "senderPrincipal": IDL2.Principal,
    "message": IDL2.Text,
    "recipientPrincipal": IDL2.Principal
  });
  const PaymentId2 = IDL2.Nat;
  const PaymentRecordStatus2 = IDL2.Variant({
    "Failed": IDL2.Null,
    "Completed": IDL2.Null,
    "Pending": IDL2.Null
  });
  const PaymentRecord2 = IDL2.Record({
    "id": PaymentId2,
    "status": PaymentRecordStatus2,
    "createdAt": Timestamp2,
    "stripePaymentId": IDL2.Text,
    "amount": IDL2.Nat,
    "principalId": IDL2.Principal
  });
  ...
  const CandidateProfileInput2 = IDL2.Record({
    "age": IDL2.Nat,
    "height": IDL2.Text,
    "city": IDL2.Text,
    "name": IDL2.Text,
  ...
  return IDL2.Service({
    ...
    "addProject": IDL2.Func([ProjectInput2], [ProjectRecord2], []),
    "approveCandidate": IDL2.Func([IDL2.Principal], [], []),
    "assignCallerUserRole": IDL2.Func([IDL2.Principal, UserRole2], [], []),
    "assignCandidateToProject": IDL2.Func([ProjectId2, IDL2.Principal], [], []),
    "broadcastNotification": IDL2.Func(
      [IDL2.Vec(IDL2.Principal), IDL2.Text, NotificationType2],
      [],
      []
    ),
    "createCheckoutSession": IDL2.Func([IDL2.Text, IDL2.Text], [IDL2.Text], []),
    "getCallerUserRole": IDL2.Func([], [UserRole2], ["query"]),
    "getCandidateDetail": IDL2.Func(
      [IDL2.Principal],
      [IDL2.Opt(CandidateProfile2)],
      ["query"]
    ),
    "getConfig": IDL2.Func([], [AppConfig2], ["query"]),
    "getMyNotifications": IDL2.Func(
      [],
      [IDL2.Vec(NotificationRecord2)],
      ["query"]
    ),
    "getMyPaymentStatus": IDL2.Func([], [IDL2.Opt(PaymentRecord2)], ["query"]),
    "getMyProfile": IDL2.Func([], [IDL2.Opt(CandidateProfile2)], ["query"]),
    "getMyProjects": IDL2.Func([], [IDL2.Vec(ProjectRecord2)], ["query"]),
    ...
    "listAllCandidates": IDL2.Func([], [IDL2.Vec(CandidateProfile2)], ["query"]),
    "listApprovals": IDL2.Func([], [IDL2.Vec(UserApprovalInfo2)], ["query"]),
    "listPayments": IDL2.Func([], [IDL2.Vec(PaymentRecord2)], ["query"]),
    "listProjects": IDL2.Func([], [IDL2.Vec(ProjectRecord2)], ["query"]),
    "markNotificationRead": IDL2.Func([NotificationId2], [], []),
    "recordPayment": IDL2.Func([IDL2.Text], [PaymentRecord2], []),
    "registerCandidate": IDL2.Func(
      [CandidateProfileInput2],
      [CandidateProfile2],
      []
    ),
    "rejectCandidate": IDL2.Func([IDL2.Principal], [], []),
    "requestApproval": IDL2.Func([], [], []),
    "sendNotification": IDL2.Func(
      [IDL2.Principal, IDL2.Text, NotificationType2],
      [NotificationRecord2],
      []
    ),
    ...
    "updateConfig": IDL2.Func([AppConfig2], [], []),
    "updateMyProfile": IDL2.Func(
      [CandidateProfileInput2],
      [CandidateProfile2],
      []
    ),
    "updateProject": IDL2.Func([ProjectId2, ProjectInput2], [ProjectRecord2], []),
    "uploadPortfolioImages": IDL2.Func([IDL2.Vec(ExternalBlob2)], [], [])
  });
};
...
var NotificationType = /* @__PURE__ */ ((NotificationType2) => {
  NotificationType2["RegistrationUpdate"] = "RegistrationUpdate";
  NotificationType2["Reminder"] = "Reminder";
  NotificationType2["Announcement"] = "Announcement";
  NotificationType2["ProjectMatch"] = "ProjectMatch";
  NotificationType2["Offer"] = "Offer";
  return NotificationType2;
})(NotificationType || {});
var PaymentStatus = /* @__PURE__ */ ((PaymentStatus2) => {
  PaymentStatus2["NotPaid"] = "NotPaid";
  PaymentStatus2["Paid"] = "Paid";
  PaymentStatus2["Verified"] = "Verified";
  return PaymentStatus2;
})(PaymentStatus || {});
var RegistrationStatus = /* @__PURE__ */ ((RegistrationStatus2) => {
  RegistrationStatus2["Approved"] = "Approved";
  RegistrationStatus2["Suspended"] = "Suspended";
  RegistrationStatus2["Rejected"] = "Rejected";
  RegistrationStatus2["Pending"] = "Pending";
...
class Backend {
  ...
  async assignCandidateToProject(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async broadcastNotification(arg0, arg1, arg2) {
    if (this.processError) {
      try {
  ...
  async createCheckoutSession(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async sendNotification(arg0, arg1, arg2) {
    if (this.processError) {
      try {
  ...
  async uploadPortfolioImages(arg0) {
    if (this.processError) {
      try {
...
function from_candid_ApprovalStatus_n54(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n55(_uploadFile, _downloadFile, value);
}
async function from_candid_CandidateProfile_n27(_uploadFile, _downloadFile, value) {
...
function from_candid_NotificationRecord_n36(_uploadFile, _downloadFile, value) {
  return from_candid_record_n37(_uploadFile, _downloadFile, value);
}
function from_candid_NotificationType_n38(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n39(_uploadFile, _downloadFile, value);
}
function from_candid_PaymentRecordStatus_n43(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n44(_uploadFile, _downloadFile, value);
}
function from_candid_PaymentRecord_n41(_uploadFile, _downloadFile, value) {
  return from_candid_record_n42(_uploadFile, _downloadFile, value);
}
function from_candid_PaymentStatus_n29(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n30(_uploadFile, _downloadFile, value);
}
function from_candid_ProjectCategory_n18(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n19(_uploadFile, _downloadFile, value);
}
function from_candid_ProjectRecord_n14(_uploadFile, _downloadFile, value) {
  return from_candid_record_n15(_uploadFile, _downloadFile, value);
}
function from_candid_ProjectStatus_n16(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n17(_uploadFile, _downloadFile, value);
}
function from_candid_RegistrationStatus_n31(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n32(_uploadFile, _downloadFile, value);
}
function from_candid_StripeSessionStatus_n46(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n47(_uploadFile, _downloadFile, value);
}
function from_candid_UserApprovalInfo_n52(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n19(_uploadFile, _downloadFile, value) {
  return "Bridal" in value ? "Bridal" : "MusicVideo" in value ? "MusicVideo" : "ECommerce" in value ? "ECommerce" : "Fashion" in value ? "Fashion" : "Jewellery" in value ? "Jewellery" : "International" in value ? "International" : "WebSeries" in value ? "WebSeries" : "BrandPromotion" in value ? "BrandPromotion" : "Catalogue" in value ? "Catalogue" : value;
}
...
function from_candid_variant_n30(_uploadFile, _downloadFile, value) {
  return "NotPaid" in value ? "NotPaid" : "Paid" in value ? "Paid" : "Verified" in value ? "Verified" : value;
}
function from_candid_variant_n32(_uploadFile, _downloadFile, value) {
  return "Approved" in value ? "Approved" : "Suspended" in value ? "Suspended" : "Rejected" in value ? "Rejected" : "Pending" in value ? "Pending" : value;
}
function from_candid_variant_n39(_uploadFile, _downloadFile, value) {
  return "RegistrationUpdate" in value ? "RegistrationUpdate" : "Reminder" in value ? "Reminder" : "Announcement" in value ? "Announcement" : "ProjectMatch" in value ? "ProjectMatch" : "Offer" in value ? "Offer" : value;
}
function from_candid_variant_n44(_uploadFile, _downloadFile, value) {
  return "Failed" in value ? "Failed" : "Completed" in value ? "Completed" : "Pending" in value ? "Pending" : value;
}
...
function to_candid_ApprovalStatus_n57(_uploadFile, _downloadFile, value) {
...
function to_candid_NotificationType_n22(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n23(_uploadFile, _downloadFile, value);
}
function to_candid_ProjectCategory_n12(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n13(_uploadFile, _downloadFile, value);
}
function to_candid_ProjectInput_n8(_uploadFile, _downloadFile, value) {
  return to_candid_record_n9(_uploadFile, _downloadFile, value);
}
function to_candid_ProjectStatus_n10(_uploadFile, _downloadFile, value) {
...
function to_candid_variant_n23(_uploadFile, _downloadFile, value) {
  return value == "RegistrationUpdate" ? {
    RegistrationUpdate: null
  } : value == "Reminder" ? {
    Reminder: null
  } : value == "Announcement" ? {
...
async function to_candid_vec_n59(_uploadFile, _downloadFile, value) {
