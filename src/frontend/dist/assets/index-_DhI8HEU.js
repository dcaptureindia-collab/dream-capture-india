import { j as jsxRuntimeExports, r as reactExports, g as reactDomExports, c as useQueryClient, L as Link, a as ue } from "./index-CebTjiTu.js";
import { a as ProjectStatus, b as ProjectCategory } from "./backend.d-DcSV0aLA.js";
import { A as AdminLayout } from "./AdminLayout-B_Ai7nyX.js";
import { R as Root$2, C as Content$1, h as Close, T as Title, P as Portal$1, O as Overlay, u as useCallbackRef, i as Portal$2, D as DismissableLayer, A as AlertDialog, a as AlertDialogContent, b as AlertDialogHeader, c as AlertDialogTitle, d as AlertDialogDescription, e as AlertDialogFooter, f as AlertDialogCancel } from "./alert-dialog-Ddh4idmz.js";
import { B as Badge } from "./badge-Bz0HIF4P.js";
import { c as createLucideIcon, X, a as cn, u as useComposedRefs, b as useBackend, d as useQuery, B as Button } from "./x-CNxy1RBN.js";
import { C as Card, b as CardHeader, c as CardTitle, B as Briefcase, a as CardContent } from "./card-CzpBPjzC.js";
...
import { P as Primitive, c as createContextScope, e as useLayoutEffect2, u as useControllableState, b as composeEventHandlers, d as Presence, f as createSlottable } from "./index-BIROJ8_8.js";
...
function AdminProjectsPage() {
  ...
  const [deleteProject, setDeleteProject] = reactExports.useState(
    null
  );
  ...
  const addMutation = useMutation({
    mutationFn: (input) => actor.addProject(input),
    onSuccess: () => {
    ...
    onError: () => ue.error("Failed to create project.")
  });
  const updateMutation = useMutation({
    mutationFn: ({ id, input }) => actor.updateProject(id, input),
    onSuccess: () => {
    ...
    onError: () => ue.error("Failed to update project.")
  });
  ...
  const openEdit = (p) => {
    setEditProject(p);
    const deadlineMs = Number(p.deadline) / 1e6;
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const deadlineTs = BigInt(new Date(form.deadline).getTime()) * BigInt(1e6);
    const input = {
      title: form.title,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AdminLayout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "admin_projects.page", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between flex-wrap gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-bold text-foreground", children: "Projects" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-1 text-sm", children: "Create and manage casting projects" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-card border-border/50", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 space-y-3", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-12 w-full" }, i)) }) : projects.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: "No projects created yet" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground/60", children: "Add a new project to start casting." }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/50 bg-muted/20", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-xs text-muted-foreground font-medium", children: "Title" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-xs text-muted-foreground font-medium hidden md:table-cell", children: "Category" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-xs text-muted-foreground font-medium hidden lg:table-cell", children: "Deadline" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-xs text-muted-foreground font-medium hidden lg:table-cell", children: "Budget" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: projects.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "tr",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-medium text-foreground max-w-[180px] truncate", children: p.title }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: statusBadge(p.status) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground hidden lg:table-cell", children: formatDate(p.deadline) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-muted-foreground hidden lg:table-cell", children: p.budget }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-end gap-1.5", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { side: "top", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", children: "Coming soon" }) })
                  ] }) })
                ] }) })
              ]
            },
      ...
      Dialog,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          DialogContent,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-display text-foreground", children: editProject ? "Edit Project" : "New Project" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "grid gap-4 py-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "proj-title", children: "Project Title *" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                      id: "proj-title",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "select",
                      {
                        ...
                        children: Object.entries(CATEGORY_LABELS).map(([val, label]) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: val, children: label }, val))
                      }
                    )
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "select",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: ProjectStatus.Draft, children: "Draft" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: ProjectStatus.Active, children: "Active" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: ProjectStatus.Closed, children: "Closed" })
                        ]
                      }
                    )
                  ] })
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "proj-req", children: "Requirements" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Textarea,
                    {
                      id: "proj-req",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "proj-budget", children: "Budget *" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Input,
                      {
                        id: "proj-budget",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "proj-deadline", children: "Deadline *" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Input,
                      {
                        id: "proj-deadline",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      ...
                      children: isSaving ? "Saving..." : editProject ? "Update Project" : "Create Project"
                    }
                  )
                ] })
              ] })
          ...
          AlertDialogContent,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { className: "font-display text-foreground", children: "Delete Not Available" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogDescription, { children: 'Project deletion is coming soon. Filhaal projects ko "Closed" status mein set kar sakte hain.' })
              ] }),
