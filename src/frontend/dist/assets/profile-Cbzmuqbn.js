import { R as React, c as useQueryClient, r as reactExports, j as jsxRuntimeExports, a as ue } from "./index-CebTjiTu.js";
...
function CandidateProfilePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CandidateLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl space-y-6", "data-ocid": "candidate_profile.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-bold text-foreground", children: profile ? "Edit Profile" : "Complete Registration" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-1 text-sm", children: "Apni details fill karo taaki casting directors aapko shortlist kar sakein" })
    ] }),
    profileLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-80 w-full" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit(onSubmit), noValidate: true, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-card border-border/50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "font-display text-base text-foreground", children: "Personal Information" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "grid grid-cols-1 sm:grid-cols-2 gap-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldError, { message: (_b = errors.email) == null ? void 0 : _b.message })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "phone", children: "Phone / WhatsApp *" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "phone",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldError, { message: (_c = errors.phone) == null ? void 0 : _c.message })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                ...
                ...register("age", {
                  ...
                  validate: (v) => Number.isInteger(Number(v)) || "Enter a valid age"
                })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldError, { message: (_e = errors.age) == null ? void 0 : _e.message })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldError, { message: (_f = errors.height) == null ? void 0 : _f.message })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 sm:col-span-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "measurements", children: "Measurements (Bust-Waist-Hip) *" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "measurements",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldError, { message: (_g = errors.measurements) == null ? void 0 : _g.message })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          ...
          children: [
            ...
            isSubmitting || saveMutation.isPending ? "Saving..." : profile ? "Update Profile" : "Register & Save"
          ]
        }
      ) })
    ] })
